...
class UserApiIntegrationTest extends IntegrationTestBase {
    ...
    void shouldReturnAllUsersOlderThan_whenGettingAllUsersOlderThan() throws Exception {
        User user1 = existingUser(generateUserWithDate(LocalDate.of(2000, 1, 11))); // ma ponad 24 lata
        User user2 = existingUser(generateUserWithDate(LocalDate.of(2024, 8, 11))); // ma mniej niż 24 lata

        mockMvc.perform(get("/v1/users/age")
                        .param("age", "24")
